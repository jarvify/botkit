...
export class BotkitConversation<O extends object = {}> extends Dialog<O> {
     ...
     */
    public ask(message: Partial<BotkitMessageTemplate> | BotkitMessageTemplateAsync | string, handlers: BotkitConvoTrigger | BotkitConvoTrigger[], key: { key: string } | string | null): BotkitConversation {
     ...
     * @param thread_name Name of thread to which message will be added
     */
    public addQuestion(msg: Partial<BotkitMessageTemplate> | BotkitMessageTemplateAsync | string, handlers: BotkitConvoTrigger | BotkitConvoTrigger[], key: { key: string } | string | null, thread_name: string): BotkitConversation {
